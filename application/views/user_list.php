...
<div class="container-fluid text center">
	<div class="row content">
		...
		<div class="col-sm-8 text-left">
			...
			<a href="<?php echo base_url(); ?>index.php/users/addnew" class="button4"><span class="glyphicon glyphicon-plus"></span> Add User</a><br><br>
				...
				<tbody>
					...
					foreach($users as $user){
						...
						<tr>
							...
							<td><a href="<?php echo base_url(); ?>index.php/users/edit/<?php echo $user->id; ?>" class="button2"><span class="glyphicon glyphicon-edit"></span> Edit</a> || <a href="<?php echo base_url(); ?>index.php/users/delete/<?php echo $user->id; ?>" class="button1"><span class="glyphicon glyphicon-trash"></span> Delete</a></td>
						</tr>
						<?php
					}
					?>
