        ...
        <div class="chart-wrapper">
          ...
          <div class="chart-stage">
            ...
            <select name="s_id" style="width: 35%;">
                ...
                <option value="0141">GRAND PARK CAREER CENTER</option><!-- Works minus Diversity-->
                <option value="0151">BRENTWOOD ELEMENTARY SCHOOL</option><!-- Doesn't Works -->
                <option value="0291">THE BRIDGE</option>
                <option value="0331">ROBERT E LEE HIGH SCHOOL</option><!-- Doesn't Works -->
                <option value="0351">ANDREW JACKSON HIGH SCHOOL</option>
                <option value="0371">HENRY F KITE ELEMENTARY SCHOOL</option><!-- Doesn't Works -->
                <option value="0471">LONE STAR HIGH SCHOOL</option><!-- Doesn't Works -->
                <option value="0491">DUVAL REGIONAL JUVENILE DETENTION CENTER</option><!-- Doesn't Works -->
                <option value="0531">DUVAL MYCROSCHOOL</option><!-- Doesn't Works -->
                <option value="0621">OCEANWAY SCHOOL</option>
                <option value="0631">DUNCAN U FLETCHER MIDDLE SCHOOL	</option><!-- Works minus Diversity-->
                ...
                <option value="0811">PACE CENTER FOR GIRLS-JAX</option><!-- Doesn't Works -->
                <option value="0821">LOVE GROVE ELEMENTARY SCHOOL</option>
                <option value="0831">SAN JOSE ELEMENTARY SCHOOL</option><!-- Doesn't Works -->
                <option value="0841">BAYVIEW ELEMENTARY SCHOOL</option><!-- Doesn't Works -->
                <option value="0851">LAKE LUCINA ELEMENTARY SCHOOL</option><!-- Doesn't Works -->
                <option value="0861">TERRY PARKER HIGH SCHOOL</option>
                <option value="0891">WOODLAND ACRES ELEMENTARY SCHOOL</option>
                <option value="0911">SALLYE B MATHIS ELEMENTARY SCHOOL</option><!-- Works minus Diversity-->
                ...
                <option value="1181">SCHOOL FOR ACCELERATED LEARNING TECHNOLOGIES</option><!-- Doesn't Works -->
                <option value="1281">SUSIE E TOLBERT ELEMENTARY SCHOOL</option><!-- Doesn't Works -->
                <option value="1461">MATTHEW W GILBERT MIDDLE SCHOOL</option>
                <option value="1491">SMART POPE LIVINGSTON ELEM</option><!-- Doesn't Works -->
                <option value="1501">NEW BERLIN ELEMENTARY SCHOOL</option><!-- Doesn't Works -->	
                <option value="1542">JOHN E FORD K-8 SCHOOL</option>
                <option value="1551">NORTHWESTERN MIDDLE SCHOOL</option>	
                <option value="1561">YWLAYMLA</option><!-- Works minus Diversity-->
                <option value="1581">GEORGE WASHINGTON CARVER ELEM</option>
                <option value="1611">BARTRAM SPRINGS ELEMENTARY</option><!-- Doesn't Works -->	
                ...
                <option value="1811">HOSPITAL AND HOMEBOUND</option><!-- Doesn't Works -->	
                <option value="1821">YOUTH DEVELOPMENT CENTER</option><!-- Doesn't Works -->
                ...
                <option value="2361">MAMIE AGNES JONES ELEMENTARY SCHOOL</option><!-- Doesn't Works -->
                <option value="2381">FORT CAROLINE MIDDLE SCHOOL</option>
                <option value="2401">ARLINGTON HEIGHTS ELEMENTARY SCHOOL</option><!-- Doesn't Works -->	
                <option value="2431">GREGORY DRIVE ELEMENTARY SCHOOL</option><!-- Doesn't Works -->	
                <option value="2441">HIGHLANDS MIDDLE SCHOOL</option>	
                <option value="2451">CROWN POINT ELEMENTARY SCHOOL</option><!-- Doesn't Works -->	
                <option value="2481">EDWARD H WHITE HIGH SCHOOL</option>	
                <option value="2501">PINE ESTATES ELEMENTARY SCHOOL</option><!-- Doesn't Works -->	
                <option value="2531">TWIN LAKES ACADEMY MIDDLE</option>
                <option value="2541">MAYPORT MIDDLE SCHOOL</option>
                <option value="2551">ENTERPRISE LEARNING ACADEMY</option><!-- Doesn't Works -->
                <option value="2561">LANDMARK MIDDLE SCHOOL</option>	
                <option value="2591">MANDARIN MIDDLE SCHOOL</option><!-- Doesn't Works -->	
                <option value="2621">ANDREW A ROBINSON ELEMENTARY SCHOOL</option>	
                <option value="2651">FIRST COAST HIGH SCHOOL</option><!-- Doesn't Works -->
                <option value="2681">ATLANTIC COAST HIGH SCHOOL</option><!-- Doesn't Works -->	
                <option value="2691">BISCAYNE ELEMENTARY SCHOOL</option><!-- Doesn't Works -->	
                <option value="2741">WESTVIEW K-8</option>	
                <option value="2791">KERNAN MIDDLE SCHOOL</option><!-- Doesn't Works -->	
                <option value="2801">FRANK H PETERSON ACADEMIES</option>	
                <option value="2851">A PHILIP RANDOLPH ACADEMIES</option>
                <option value="3518">MCKAY SCHOLARSHIPSCHOOL OF EN</option><!-- Doesn't Works -->
                <option value="5421">BISCAYNE HIGH SCHOOL</option>
                <option value="5611">BRIDGEPREP ACADEMY DUVAL COUNTY</option><!-- Doesn't Works -->
                <option value="5631">SEASIDE CHARTER K-8 SCHOOL</option><!-- Doesn't Works -->	
                <option value="N998">Home Education Setting</option><!-- Doesn't Works -->
            </select>
            <br><br>
